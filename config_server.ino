...
//    WiFi.mode(WIFI_STA);
//    WiFi.disconnect();
//    WiFi.begin(HTTP.arg("ssid").c_str(), HTTP.arg("psk").c_str());
//    delay(5000);
//    
//    Serial.printf("Connection status: %d\n", WiFi.status());
//    HTTP.send(200, "text/plain", String(WiFi.status()));
//
//    ESP.restart();
//
//
//  } else {
//    HTTP.send(404, "text/plain", "XZ");
//  }
//}
//
...
////    }
////  }
////  HTTP.on("/generate_204", available_networks_handler);
